export default {
	...
	"thunder-link-tips":
		"نصيحة: قد لا تكون روابط الرعد قابلة للتحميل بعد فك التشفير",
	...
	"batch-delete-task-confirm":
		"هل انت متأكد أنك تريد حذف {{count}} التحميلات دفعة واحدة",
	...
	"remove-task-config-file-fail":
		"فشل في حذف ملف تهيئة التحميل (config file)، يرجى حذفه يدويًا",
	...
	"remove-record-confirm":
		'هل أنت متأكد انك تريد حذف سجل التحميل الخاص بـ "{{taskName}}" ؟',
