export default {
	"sort-ascending": "Възходящо",
	"sort-descending": "Низходящо",
	"torrent-preview-folder-select": "Избери",
	active: "Активен",
	waiting: "чакане",
	stopped: "спряно",
	...
	"thunder-link-tips":
		"съвет: връзките от типа Thunder може да не се зареждат след декодиране",
	...
	"copyright-error-message":
		"грешка при добавяне на задача поради проблеми с авторските права",
	...
	"delete-task-confirm":
		'сигурни ли Сте, че искате да изтриете задачата "{{taskName}}"?',
	...
	"remove-record-fail":
		'грешка при изтриване на запис за задача "{{taskName}}"',
	...
	"BT-download-complete-tips":
		"съвет: можете да спрете задачата, за да спрете раздаването",
	...
	"filter-image": "Избери файлове с изображения",
	"filter-document": "Избери документи",
