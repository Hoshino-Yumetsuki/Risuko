export default {
	...
	"new-task-uris-required":
		"Per favor, introdueix al menys una URL de recurs vàlida",
	...
	"copyright-error-message":
		"No s'ha pogut afegir una tasca degut a un problema de drets d'autor",
	"pause-task-success": 'S\'ha pausat la tasca "{{taskName}}"',
	"pause-task-fail":
		'Hi ha hagut un problema al pausar la tasca "{{taskName}}"',
	...
	"delete-task-confirm":
		'Estàs segur que vols eliminar la tasca "{{taskName}}"?',
	...
	"delete-task-fail":
		'Hi ha hagut un error en eliminar la tasca "{{taskName}}"',
	...
	"bt-download-complete-message":
		"Descàrrega completada {{taskName}}. Compartint...",
	"bt-download-complete-notify": "Descàrrega BT completa. Compartint...",
	"bt-download-complete-tips":
		"Tips: Pot detenir una tasca per deixar de compartir",
