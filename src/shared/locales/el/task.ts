export default {
	...
	"pause-task-success":
		'Η παύση της εργασίας "{{taskName}}" ολοκληρώθηκε επιτυχώς',
	...
	"remove-record-success":
		'Επιτυχής διαγραφή της εγγραφής της εργασίας "{{taskName}}"',
	"remove-record-fail":
		'Η διαγραφή της εγγραφής της εργασίας"{{taskName}}" απέτυχε',
	...
	"bt-download-complete-message":
		"Η λήψη του {{taskName}} ολοκληρώθηκε, γίνεται διαμοιρασμός",
	"bt-download-complete-notify":
		"Μία λήψη BT ολοκληρώθηκε, γίνεται διαμοιρασμός...",
	...
	"mirror-add": "Προσθήκη καθρέφτη",
	"mirror-remove": "Αφαίρεση καθρέφτη",
	"mirror-placeholder": "URL καθρέφτη (ίδιο αρχείο, άλλος διακομιστής)",
	"mirror-hint":
	...
	"filter-video": "Επιλογή αρχεία βίντεο",
	"filter-audio": "Επιλογή αρχεία ήχου",
	"filter-image": "Επιλογή αρχεία εικόνας",
	"filter-document": "Επιλογή αρχεία εγγράφων",
