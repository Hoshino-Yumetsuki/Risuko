export default {
	...
	"schedule-dialog-hint":
		"The download stays paused and starts automatically at the time you pick.",
	"schedule-pick-time": "Pick a start time",
	...
	"uri-task-tips": "One task url per line (supports magnet, ed2k, m3u8)",
	"thunder-link-tips":
	...
	"ssh-private-key-path-tips": "Select a PEM private key file",
	"ssh-private-key-paste-tips": "Or paste PEM key content directly",
	"ssh-key-passphrase": "Key Passphrase",
	"ssh-key-passphrase-tips": "Leave empty if no passphrase",
	...
	"new-task-file-required": "Please select a torrent or metalink file",
	...
	"download-file-detected": "Download file detected",
	"download-file-detected-multi": "{{count}} download files detected",
	"file-name": "Name",
	...
	"filter-video": "Select video files",
	"filter-audio": "Select audio files",
	"filter-image": "Select image files",
	"filter-document": "Select document files",
	...
	"task-proxy": "Proxy",
	"task-proxy-placeholder": "[http://][USER:PASSWORD@]HOST[:PORT]",
	...
	"torrent-preview-disabled-size":
		"Torrent file is too large to preview safely.",
	...
	"sync-priority-failed": "Syncing priority failed",
	"saved-credentials-found": "Saved credentials for {{host}}",
	"saved-credentials-profiles": "Saved Profiles",
	"apply-credential": "Apply",
	"save-credential": "Save Credentials",
	"save-credential-for-host": "Save for {{host}}",
