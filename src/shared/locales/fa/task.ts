export default {
	...
	"thunder-link-tips":
		"نکته: پیوند‌های تاندر ممکن هست بعد کدگشایی قابل بارگیری نباشند",
	...
	"batch-delete-task-confirm":
		"آیا از حذف {{count}} وظیفه به صورت دسته جمعی مطمئنید؟",
	...
	"remove-task-file-fail":
		"حذف وظیفه(ها) شکست خورد، لطفاً به صورت دستی حذفشان کنید",
	...
	"remove-record-success":
		'پاک کردن سابقهٔ وظیفه "{{taskName}}" با موفقیت انجام شد',
	...
	"bt-download-complete-tips":
		"نکات: شما می‌توانید با توقف یک وظیفه، به بذرپاشی آن را پایان دهید",
