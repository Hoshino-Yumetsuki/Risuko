export default {
	...
	"copyright-warning-message":
		"A fájl Szerzöi jogi akkor gyözödjön meg arol hogy van joga hozzá.",
	"copyright-yes": "Igen, van jogom hozzá",
	"copyright-no": "Nem, nincs jogom hozzá",
	"copyright-error-message":
		"Nem sikerült hozzá addni a feladatot szerzöi jog miatt",
	...
	"remove-task-file-fail":
		"Sikertelen volt a fájlok törlés, kérjük törölje manualisan",
