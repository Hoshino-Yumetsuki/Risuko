export default {
	...
	"thunder-link-tips":
		"注意：Thunder(Xunlei)リンク解析後、ダウンロードできるかは保証できません",
	"new-task-uris-required":
		"少なくとも1つの有効なリソースURLを入力してください",
	...
	"selected-files-sum":
		"選択済み：{{selectedFilesCount}}ファイル、合計{{selectedFilesTotalSize}}",
	...
	"task-info-hash": "ハッシュ",
	"task-info-hash-v2": "ハッシュ v2",
	"task-meta-version": "メタバージョン",
	...
	"remove-task-file-fail":
		"ダウンロードファイルの削除に失敗、手動で削除してください",
	"remove-task-config-file-fail":
		"タスク設定ファイルの削除に失敗、手動で削除してください",
	...
	"bt-download-complete-message":
		"{{taskName}} のダウンロードに成功、seedを作成中...",
	"bt-download-complete-notify":
		"torrentタスクのダウンロードに成功，seedを作成中...",
	"bt-download-complete-tips":
		"ヒント：タスクを停止しseedの作成を終了することができます",
	...
	"more-actions": "その他の操作",
	"filter-video": "選択 動画ファイル",
	"filter-audio": "選択 音声ファイル",
	"filter-image": "選択 画像ファイル",
	"filter-document": "選択 ドキュメントファイル",
