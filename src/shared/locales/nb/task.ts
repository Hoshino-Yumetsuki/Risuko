export default {
	...
	"copyright-error-message":
		"Kunne ikke legge til oppgave på grunn av problem med opphavsrett",
	...
	"delete-task-confirm":
		'Er du sikker på at du vil fjerne nedlastingsoppgaven "{{taskName}}"?',
	...
	"remove-task-file-fail":
		"Kunne ikke slette oppgavefil (er), vennligst slett dem manuelt",
	"remove-task-config-file-fail":
		"Kunne ikke slette oppgavekonfigurasjonsfilen. Slett den manuelt",
	...
	"remove-record-confirm":
		'Er du sikker på at du vil fjerne nedlastingsposten for "{{taskName}}"?',
	"remove-record-label": "Slett med filer",
	"remove-record-success": 'Nedlastingsposten for "{{taskName}}" er fjernet',
	"remove-record-fail":
		'Kunne ikke fjerne nedlastingsposten for "{{taskName}}"',
	...
	"download-error-message":
		"Det oppstod en feil under nedlasting av {{taskName}}",
	...
	"bt-download-complete-message":
		"Nedlastingen er fullført, {{taskName}}, seeding",
	"bt-download-complete-notify": "BT-nedlasting fullført, seeding...",
	"bt-download-complete-tips":
		"Tips: Du kan stoppe en oppgave for å avslutte seedingen",
