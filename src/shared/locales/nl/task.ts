export default {
	...
	"unknown-task-type": "Niet-ondersteund taaktype",
	"open-file": "Torrentbestand openen...",
	"uri-task": "URL",
	"torrent-task": "Torrent",
	"uri-task-tips": "Een taak URL per regel (ondersteunt magnet)",
	"thunder-link-tips":
		"Tip: Thunder links zijn mogelijk niet downloadbaar na decodering",
	...
	"copyright-error-message":
		"Kon taak niet toevoegen vanwege copyright probleem",
	...
	"delete-task-confirm":
		'Weet u zeker dat u de download van "{{taskName}}" wilt verwijderen?',
	"batch-delete-task-confirm":
		"Weet u zeker dat u {{count}} taken in 1 keer verwijderen?",
	...
	"remove-task-file-fail":
		"Bestand verwijderen mislukt, gelieve handmatig verwijderen",
	...
	"remove-record-success":
		'Taakrecord voor "{{taskName}}" succesvol verwijderd',
	"remove-record-fail":
		'Taakrecord voor "{{taskName}}" kon niet verwijderd worden',
	...
	"select-torrent":
		"Sleep torrentbestand hier naartoe of klik om te selecteren",
	...
	"bt-download-complete-message":
		"Download van {{taskName}} voltooid, seeden...",
	"bt-download-complete-notify": "BT Download voltooid, seeden...",
	"bt-download-complete-tips":
		"Tip: U kunt een taak stoppen om het seeden de beëindigen",
