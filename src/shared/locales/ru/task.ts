export default {
	...
	"torrent-preview-folder-select": "Выбрать",
	active: "Загрузки",
	waiting: "Ожидание",
	stopped: "Остановлено",
	"new-task": "Новое задание",
	"new-bt-task": "Новое BT задание",
	"unknown-task-type": "Неподдерживаемый тип задания",
	"open-file": "Открыть Torrent файл...",
	"uri-task": "URL",
	"torrent-task": "Torrent",
	"uri-task-tips": "Один URL-задания в строку (поддержка magnet)",
	"thunder-link-tips":
		"Совет: Ссылки типа Thunder могут не загружаться после декодированния",
	"new-task-uris-required":
		"Введите хотя бы один действительный URL-адрес ресурса",
	...
	"copyright-error-message":
		"Ошибка при добавлении задачи из-за проблем с авторскими правами",
	...
	"delete-task-confirm":
		'Вы уверены, что хотите удалить задание "{{taskName}}"?',
	...
	"remove-record-confirm":
		'Вы уверены, что хотите удалить запись про задание "{{taskName}}"?',
	...
	"bt-download-complete-tips":
		"Совет: Вы можете остановить задачу, чтобы остановить раздачу",
	...
	"completion-script-override":
		"Переопределить скрипт завершения для этой задачи",
	"mirror-add": "Добавить зеркало",
	"mirror-remove": "Удалить зеркало",
	"mirror-placeholder": "URL зеркала (тот же файл, другой сервер)",
	"mirror-hint":
	...
	"filter-image": "Выбрать файлы изображений",
	"filter-document": "Выбрать файлы документов",
