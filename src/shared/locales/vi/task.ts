export default {
	...
	"thunder-link-tips":
		"Mẹo: Liên kết Thunder có thể không tải được sau khi giải mã",
	...
	"delete-task-confirm":
		'Bạn có chắc chắn muốn xóa tác vụ tải xuống "{{taskName}}"?',
	"batch-delete-task-confirm":
		"Bạn có chắc chắn muốn xóa {{Count}} tác vụ tải xuống không?",
	...
	"remove-record-confirm":
		'Bạn có chắc chắn muốn xóa bản ghi tải xuống cho "{{taskName}}" không?',
	...
	"bt-download-complete-message":
		"Đã hoàn tất tải xuống {{taskName}}, đang seed",
	"bt-download-complete-notify": "BT đã hoàn tất tải xuống, đang seed...",
	"bt-download-complete-tips":
		"Mẹo: Bạn có thể dừng một tác vụ để kết thúc việc seed",
