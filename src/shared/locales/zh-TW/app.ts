export default {
	...
	"open-url": "開啟 URL",
	"open-url-failed": "無法開啟 URL",
	"increase-value": "增加數值",
	"decrease-value": "減少數值",
	"previous-month": "上個月",
	"next-month": "下個月",
	"update-checking": "正在檢查更新...",
	"update-unavailable": "目前沒有可用更新",
	"update-available": "有可用更新",
	"update-download": "下載更新",
	"update-cancelled": "更新已取消",
	"update-install": "安裝更新",
	"update-relaunch": "重新啟動以完成更新",
	"update-progress": "更新進度: {{progress}}%",
	"update-error": "更新錯誤: {{error}}",
	"update-unsigned": "此版本無法使用更新",
};
