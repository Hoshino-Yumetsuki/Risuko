export default {
	...
	completed: "已完成",
	"start-now": "立即開始",
	"start-now-fail": "無法立即開始「{{taskName}}」",
	"schedule-fail": "排程下載失敗",
	"missed-schedule-start-all-fail": "{{count}} 個排程下載開始失敗",
	"schedule-task": "排程開始…",
	"reschedule-task": "重新排程…",
	"schedule-dialog-title": "排程下載",
	"schedule-dialog-hint": "任務將保持暫停，並在所選時間自動開始。",
	"schedule-pick-time": "選擇開始時間",
	"schedule-confirm": "排程",
	"schedule-start-at": "時間",
	"schedule-start-at-placeholder": "未排程 — 立即開始",
	"schedule-torrent-ignored": "排程時間不會套用到種子任務。",
	"starting-after": "{{duration}}後開始",
	"missed-schedule-title": "錯過的排程下載",
	"missed-schedule-hint":
		"這些下載在應用程式關閉時已到期。可立即開始，或在「排程中」分頁重新排程。",
	"missed-schedule-dismiss": "忽略",
	"missed-schedule-start-all": "全部開始",
	"reorder-handle": "重新排序任務（使用方向鍵移動）",
	"new-task": "新增任務",
	"new-bt-task": "新增 BT 任務",
	"unknown-task-type": "不支援的任務類型",
	"open-file": "開啟種子檔案...",
	"uri-task": "連結任務",
	"torrent-task": "種子任務",
	"uri-task-tips":
